...
#define DISPLAY_TYPE_FISCHER (1<<2)
#define DISPLAY_TYPE_KINGMETER      (DISPLAY_TYPE_KINGMETER_618U|DISPLAY_TYPE_KINGMETER_901U|DISPLAY_TYPE_FISCHER)
//#define DISPLAY_TYPE DISPLAY_TYPE_KINGMETER_901U
#define DISPLAY_TYPE DISPLAY_TYPE_FISCHER
...
#define OFFSET_C 1211//981				//Offset of current sensing phase C
